...
function Login() {
  ...
  const { values, touched, handleBlur, handleSubmit, handleChange, isSubmitting, errors, resetForm } = useFormik({
    initialValues: {
      username: "",
      password: "",
    },
      ...
      <div className='login-form'>
        ...
        <form onSubmit={handleSubmit}>
          <div className='username-container-login'>
            ...
            {errors.username && <p className='username-error-login'>{errors.username}</p>}
          </div>
          <div className='password-container-login'>
            ...
            {errors.password && <p className='password-error-login'>{errors.password}</p>}
          </div>
          <input type="submit" className='login-submit-button' value={'Log in'} disabled={isSubmitting} />
        </form>
      </div>
    </div>
  );
